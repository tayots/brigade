...
<div class="container">
    ...
    <div class="col-lg-11">
        <fieldset>
            <legend><span class="glyphicon glyphicon-star" style="color:orange;"></span> Monthly <span style="color:orange;">Special</span>  Reports</legend>
            <form class="form-horizontal" role="form" action='<?= base_url();?>index.php/main/monthly_special_reports' method="post">
                <div class="form-group">
                    ...
                    <div class="bs-example" data-example-id="single-button-dropdown">
                        ...
                        <div class="btn-group">
                            <a href="<?= base_url();?>index.php/main/monthly_special_reports" class="btn btn-default" >Clear</a>
                        </div>
                        <div class="btn-group">
