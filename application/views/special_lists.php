...
<head>
    ...
    <script type="text/javascript">
        function loadFireLocation() {
            document.getElementById("special_review_form").submit();
        }
...
<div class="container">
    ...
    <div class="col-lg-12">
        <fieldset>
            <legend style="color: deepskyblue;"><span class="glyphicon glyphicon-list"></span> Browse Special Activities</legend>
            <form class="form-horizontal" role="form" id="special_review_form" action='<?= base_url();?>index.php/special/lists' method="post">
                <div class="form-group">
                   ...
                   <div class="col-lg-4">
                        <div class="bs-example" data-example-id="single-button-dropdown">
                           ...
                           <div class="btn-group">
                               <a href="<?= base_url();?>index.php/special/lists" class="btn btn-default" >This Month</a>
                           </div>
                           <div class="btn-group">
            ...
            <div >
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        <?php if (count($special_list) > 0) {?>
                            <?php foreach ($special_list as $key => $value) {?>
                            <tr>
                                <td title="show details"><a href="special_details/<?=$value->id;?>" data-toggle="modal" data-target="#myLargeModalLabel"><?php echo date('l, M d, Y',strtotime($value->date_of_special)); ?> <span class="glyphicon glyphicon-share"></span></a></td>
                                <td><?php echo $value->venue; ?></td>
                                <td><?php echo $value->activity; ?></td>
                                <td style="text-align: center" title="show details"><a href="special_details/<?=$value->id;?>" data-toggle="modal" data-target="#myLargeModalLabel"><?php echo $value->total; ?> <span class="glyphicon glyphicon-share"></span></a></td>
                                ...
                                <td style="text-align: center">
                                    <?php if($value->approved_by == null){ ?>
                                        <a href="special_details/<?=$value->id;?>" data-toggle="modal" data-target="#myLargeModalLabel">Review</a>
                                    <?php } else { ?>
                                    <?php echo $value->approved_by; ?>
                                    <?php } ?>
                                </td>
                                <td title="show actions">
                                    <a href="special_details/<?=$value->id;?>" data-toggle="modal" data-target="#myLargeModalLabel">View</a> |
                                    <a href="special_edit/<?=$value->id;?>" data-toggle="modal" data-target="#editspecialDetails">Edit</a> |
                                    <?php if($value->approved_by == null){ ?>
                                    <a href="#" onclick="return sendSpecial(<?=$value->id;?>);">Send</a>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php } ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Special Activity Details</h4>
            </div>
...
<!-- Modal EDIT-->
<div id="editspecialDetails" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Edit Special Activity</h4>
            </div>
            <div class="modal-body">
...
<script type="text/javascript">
    function sendSpecial(special_id) {
        if (confirm('Do you want to email this sepcial activity detail?')){
            ...
            if (p != ''){
                ...
                var person = { email: p, special_id: special_id };
