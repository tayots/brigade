            ...
            <div style="height: 200px;">
                <div class="col-lg-7">
                    ...
                    <div class="container">
                        ...
                        <div class="col-lg-2">
                            <input tabindex="0" type="text" class="form-control input-sm" style="width:50px" name="water_used" id="water_used" value="<?php echo $value->water_used; ?>" placeholder="Tons">
                        </div>
                    </div>
                    <div class="container">
                        <div class="col-lg-2">
